...
# LINCS diagnostics from the first steps of a freshly packed box are only worth
# keeping when minimisation failed.
...
# -update gpu is left off: it can fail with CUDA error 700 during the first
# pressure-coupled steps.
